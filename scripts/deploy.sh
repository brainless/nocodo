...
DEFAULT_PROJECTS_PATH="$(toml_get "$CONFIG_FILE" deploy projects_default_path || true)"
DEFAULT_PROJECTS_PATH="${DEFAULT_PROJECTS_PATH:-$(toml_get "$CONFIG_FILE" projects default_path || true)}"
