...
import type { SettingsResponse, ApiKeyConfig } from '../types';
...
const Settings: Component = () => {
  ...
  console.log('Settings component render - loading:', loading(), 'error:', error(), 'settings:', settings());
    ...
    <div>
      ...
      <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <div class="text-blue-800 space-y-2">
          <p>
            Configure your AI provider API keys in the configuration file to enable AI-assisted development features.
          </p>
          <p>
      ...
      <div class="bg-gray-50 border border-gray-200 rounded-lg p-6">
        ...
        <div class="text-gray-700 space-y-3">
          <p>Add your API keys to the <code class="px-1 py-0.5 bg-gray-200 rounded text-sm">[api_keys]</code> section in your configuration file:</p>
...
anthropic_api_key = "your-anthropic-api-key-here"`}
          ...
          <p class="text-sm text-gray-600">
            <strong>Note:</strong> Restart the nocodo manager after updating the configuration file for changes to take effect.
          </p>
        </div>
      </div>
      ...
      <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6">
        ...
        <div class="text-yellow-800 space-y-2 text-sm">
          <p><strong>Grok:</strong> Get your API key from <a href="https://console.x.ai/" target="_blank" rel="noopener noreferrer" class="underline">X.AI Console</a></p>
          <p><strong>OpenAI:</strong> Get your API key from <a href="https://platform.openai.com/api-keys" target="_blank" rel="noopener noreferrer" class="underline">OpenAI Platform</a></p>
          <p><strong>Anthropic:</strong> Get your API key from <a href="https://console.anthropic.com/" target="_blank" rel="noopener noreferrer" class="underline">Anthropic Console</a></p>
        </div>
      </div>
            </div>
          );
