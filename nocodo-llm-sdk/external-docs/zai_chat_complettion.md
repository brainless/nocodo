    ...
    ChatCompletionTextRequest:
      ...
      properties:
        model:
          type: string
          description: >-
            The model code to be called. GLM-4.6 are the latest flagship model
        ...
        temperature:
          ...
          description: >-
            ...
            a positive number within the range: `[0.0, 1.0]`. The GLM-4.6 series
            default value is `1.0`, GLM-4.5 series default value is `0.6`,
            GLM-4-32B-0414-128K default value is `0.75`.
          format: float
          example: 1
          default: 1
          minimum: 0
        ...
        top_p:
          ...
          description: >-
            ...
            1.0]`. The GLM-4.6, GLM-4.5 series default value is `0.95`,
        ...
        max_tokens:
          type: integer
          description: >-
            The maximum number of tokens for model output, the GLM-4.6 series
            supports 128K maximum output, the GLM-4.5 series supports 96K
      ...
      properties:
        type:
          ...
          description: >-
            ...
            GLM-4.6V, GLM-4.5 and others will automatically determine whether to
            think, while GLM-4.5V will think compulsorily), default: enabled
          default: enabled
          enum:
            - enabled
            - disabled
