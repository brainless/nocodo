...
mod tests {
    ...
    // Run with: ANTHROPIC_API_KEY=sk-... cargo test --test integration
    ...
    async fn test_real_api_call() {
        ...
        assert_eq!(response.role, crate::claude::types::ClaudeRole::Assistant);
    ...
    async fn test_invalid_api_key() {
        ...
        match response.unwrap_err() {
            crate::error::LlmError::Authentication { .. } => {},
