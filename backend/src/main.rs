...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        ...
        App::new()
            ...
            .service(agents_api::db_engineer::list_tasks)
            .service(agents_api::db_engineer::list_epics)
            .service(agents_api::db_engineer::get_board)
            .service(agents_api::db_engineer::send_chat_message)
            .service(agents_api::db_engineer::get_task_messages)
            .service(agents_api::db_engineer::get_task_schema)
            .service(agents_api::db_engineer::get_message_response)
            .service(agents_api::db_engineer::generate_task_schema_code)
            .service(agents_api::project_manager::init_pm_project)
            .service(agents_api::project_manager::send_pm_chat_message)
            .service(agents_api::project_manager::get_pm_message_response)
            .service(agents_api::project_manager::get_pm_task_messages)
            ...
            .service(agents_api::context::handlers::gather_context)
            .service(agents_api::context::handlers::get_context)
            ...
            .service(agents_api::comments::handlers::add_task_comment)
